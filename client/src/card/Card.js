...
export default class Card extends React.Component{
    ...
    render() {
        ...
        return <div className="card-main">
            ...
            <h1><Truncate onTruncate={this.handleTruncate} lines={2} ellipsis={<span>... <CustomizedDialogs newsTitle={content.title} shareUrl={content.url}/><Trash deleteItem = {deleteItem} id={content.id} title={content.title}/></span>}>{content.title}</Truncate>
                {this.state.truncated? null : <span> <CustomizedDialogs newsTitle={content.title} shareUrl={content.url}/><Trash deleteItem = {deleteItem} id={content.id} title={content.title}/></span>}</h1>
